  ...
  return (
    <Card className="text-white h-[750px] lg:h-[950px] border-none overflow-hidden flex gap-4 flex-col">
      <CardHeader className="rounded-2xl p-0 py-3">
        <CardTitle className="text-2xl font-bold">DEVOLUÇÕES</CardTitle>
        <CardDescription className="text-white">Página de gereciamento de pedidos de devolução</CardDescription>
      </CardHeader>
              ...
              <Table className="">
                ...
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell>voltando</TableCell>
                    <TableCell>Roupa do tamanho errado</TableCell>
                    <TableCell className="text-right">Gratuita</TableCell>
